...
module.exports = {
    ...
    async execute(interaction) {
        ...
        /*
        // user data validation check - disabled for now, may not use since might cause usability issues
        ...
        if (userData.blacklist) return interaction.reply({
            content: "I'm sorry, but you have been blacklisted from using this application. Please contact the application owner for assistance or to appeal this action.",
