...
module.exports = {
    ...
    async execute(interaction) {
        ...
        let ticketData, ticketThread; // reserved variables for ticket command
        ...
        if (subcommand === "lock" || subcommand === "unlock") {
            ...
            if (ticketThread.isThread()) {
                ...
                if (member.permissions.has(PermissionFlagsBits.ManageThreads) && member.roles.cache.has(ticketsModRole.id)) {
                    if (subcommand === "lock" && !(ticketThread.locked || ticketData.get("ticketState") === schema.tickets.states.LOCKED)) {
                    ...
                    if (subcommand === "unlock" && !(!ticketThread.locked || ticketData.get("ticketState") === schema.tickets.states.OPEN)) {
