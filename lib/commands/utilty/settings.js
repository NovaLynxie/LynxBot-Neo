...
const { SlashCommandBuilder, InteractionContextType, ChannelType, EmbedBuilder, MessageFlags, codeBlock, PermissionFlagsBits } = require("discord.js");
                        ...
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .addFields(
                                    ...
                                    { name: "App Owner", value: appInfo.owner?.tag ?? "Unknown", inline: true },
