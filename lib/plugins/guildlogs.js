...
async function fetchGuildLogChannels(client, guild) {
    // fetch our guild's log channels and return resolved channel data.
    client.storage.models;
};
// guild log plugin main functions
async function createAuditEventLog(action, guild, channel, executor, target) { // TODO: Implement auditLog embed output...? (unused)
