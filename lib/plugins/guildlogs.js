const { AuditLogEvent, EmbedBuilder, Events, channelMention, codeBlock, time } = require("discord.js");
...
async function createAuditEventLog(action, guild, channel, executor, target) {
    ...
    let auditEventLogEmbed = new createGuildLogEmbed(); // generate guild logs base embed and stores for reference calls
    switch (action) {
    ...
    switch (event) {
        ...
        case Events.GuildRoleUpdate:
            ...
            if (oldRole.permissions.bitfield !== newRole.permissions.bitfield) {
                const generatePermissionChanges = (oldPerms, newPerms) => {
