...
const client = new Client({
    ...
    intents: [
        ...
        GatewayIntentBits.MessageContent // required for text channel moderation
    ],
    presence: {
        activities: [
            { name: "custom_status.booting_up", state: "Booting up...", type: ActivityType.Custom }
        ],
        status: "dnd"
    },
    // bot custom properties
    config: {
        developers: config?.developer.developerIds ?? [],
