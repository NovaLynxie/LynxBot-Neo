...
function generatePermissionOverwritesDiff(oldPermOverwrites, newPermOverwrites) {
    const oldAllowArray = oldPermOverwrites.allow.toArray();
    const oldDenyArray = oldPermOverwrites.deny.toArray();
    const newAllowArray = newPermOverwrites.allow.toArray();
    const newDenyArray = newPermOverwrites.deny.toArray();
